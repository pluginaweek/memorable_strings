...
desc 'Test the password_generation plugin.'
...
desc 'Generate documentation for the password_generation plugin.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PasswordGeneration'
...
spec = Gem::Specification.new do |s|
  ...
  s.require_path    = 'lib'
  s.autorequire     = 'password_generation'
  s.has_rdoc        = true
